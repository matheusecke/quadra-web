...
const buildMatchDetail = (overrides: Partial<MatchDetail> = {}): MatchDetail => ({
  ...
  bracketRound: null,
  scoreSource: null,
  homeTeam: { tournamentTeamId: 11, teamName: 'Time 1', score: null, result: null, lossType: null, isWinner: null },
  awayTeam: { tournamentTeamId: 12, teamName: 'Time 2', score: null, result: null, lossType: null, isWinner: null },
  periods: [],
  playerStats: [],
  mvp: null,
  ...overrides,
